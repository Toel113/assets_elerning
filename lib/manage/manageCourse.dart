      ...
      courseRef.get().then((docSnapshot) {
        if (docSnapshot.exists) {
          courseRef.update({
            ...
            print('อัปเดตเอกสาร ${courseData.docname} สำเร็จ');
          }).catchError((error) {
            print('เกิดข้อผิดพลาดในการอัปเดตเอกสาร: $error');
          });
        } else {
          courseRef.set({
            courseData.docname: courseData.docname,
          }).then((_) {
            print('เพิ่มเอกสาร ${courseData.docname} สำเร็จ');
          }).catchError((error) {
            print('เกิดข้อผิดพลาดในการเพิ่มเอกสารใหม่: $error');
          });
        }
      }).catchError((error) {
        print('เกิดข้อผิดพลาดในการตรวจสอบเอกสาร: $error');
      });
