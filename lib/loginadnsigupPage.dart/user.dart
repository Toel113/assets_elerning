...
class userRegisPageState extends StatefulWidget {
  @override
  _userRegisPageState createState() => _userRegisPageState();
}

class _userRegisPageState extends State<userRegisPageState> {
